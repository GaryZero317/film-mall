...
const (
	...
	User_SubmitCustomerService_FullMethodName = "/user.User/SubmitCustomerService"
	User_GetServiceList_FullMethodName        = "/user.User/GetServiceList"
	User_GetServiceDetail_FullMethodName      = "/user.User/GetServiceDetail"
	User_GetFaqList_FullMethodName            = "/user.User/GetFaqList"
)
...
func (c *userClient) SubmitCustomerService(ctx context.Context, in *CustomerServiceRequest, opts ...grpc.CallOption) (*CustomerServiceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CustomerServiceResponse)
	err := c.cc.Invoke(ctx, User_SubmitCustomerService_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetServiceList(ctx context.Context, in *ServiceListRequest, opts ...grpc.CallOption) (*ServiceListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ServiceListResponse)
	err := c.cc.Invoke(ctx, User_GetServiceList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetServiceDetail(ctx context.Context, in *ServiceDetailRequest, opts ...grpc.CallOption) (*ServiceDetailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ServiceDetailResponse)
	err := c.cc.Invoke(ctx, User_GetServiceDetail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetFaqList(ctx context.Context, in *FaqListRequest, opts ...grpc.CallOption) (*FaqListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FaqListResponse)
	err := c.cc.Invoke(ctx, User_GetFaqList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	// 客服服务
	SubmitCustomerService(context.Context, *CustomerServiceRequest) (*CustomerServiceResponse, error)
	GetServiceList(context.Context, *ServiceListRequest) (*ServiceListResponse, error)
	GetServiceDetail(context.Context, *ServiceDetailRequest) (*ServiceDetailResponse, error)
	GetFaqList(context.Context, *FaqListRequest) (*FaqListResponse, error)
...
func (UnimplementedUserServer) SubmitCustomerService(context.Context, *CustomerServiceRequest) (*CustomerServiceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SubmitCustomerService not implemented")
}
func (UnimplementedUserServer) GetServiceList(context.Context, *ServiceListRequest) (*ServiceListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetServiceList not implemented")
}
func (UnimplementedUserServer) GetServiceDetail(context.Context, *ServiceDetailRequest) (*ServiceDetailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetServiceDetail not implemented")
}
func (UnimplementedUserServer) GetFaqList(context.Context, *FaqListRequest) (*FaqListResponse, error) {
...
func _User_SubmitCustomerService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CustomerServiceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).SubmitCustomerService(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_SubmitCustomerService_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).SubmitCustomerService(ctx, req.(*CustomerServiceRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _User_GetServiceList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ServiceListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).GetServiceList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_GetServiceList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetServiceList(ctx, req.(*ServiceListRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _User_GetServiceDetail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ServiceDetailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).GetServiceDetail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_GetServiceDetail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetServiceDetail(ctx, req.(*ServiceDetailRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _User_GetFaqList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FaqListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).GetFaqList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_GetFaqList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetFaqList(ctx, req.(*FaqListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SubmitCustomerService",
			Handler:    _User_SubmitCustomerService_Handler,
		},
		{
			MethodName: "GetServiceList",
			Handler:    _User_GetServiceList_Handler,
		},
		{
			MethodName: "GetServiceDetail",
			Handler:    _User_GetServiceDetail_Handler,
		},
		{
			MethodName: "GetFaqList",
			Handler:    _User_GetFaqList_Handler,
		},
	},
